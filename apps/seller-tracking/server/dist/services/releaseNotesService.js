...
exports.sendReleaseNotesEmail = exports.buildReleaseNotesText = exports.buildReleaseNotesHtml = void 0;
...
const escapeHtml = (value) => value
    ...
    .replace(/"/g, '&quot;')
    .replace(/'/g, '&#39;');
const buildListMarkup = (items, emptyLabel) => {
    if (items.length === 0) {
...
const buildReleaseNotesHtml = (input) => `
  <!DOCTYPE html>
  <html lang="pt-BR">
    <head>
      <meta charset="UTF-8" />
...
`;
exports.buildReleaseNotesHtml = buildReleaseNotesHtml;
const buildReleaseNotesText = (input) => [
...
exports.buildReleaseNotesText = buildReleaseNotesText;
const sendReleaseNotesEmail = async (input) => {
    const payload = {
    ...
    await (0, emailTransportService_1.sendBrevoEmail)({
        ...
        htmlContent: (0, exports.buildReleaseNotesHtml)(payload),
        textContent: (0, exports.buildReleaseNotesText)(payload),
    });
};
exports.sendReleaseNotesEmail = sendReleaseNotesEmail;
