...
const normalizeAnymarketStatusKey = (value: unknown) =>
  normalizeText(value)
    .normalize('NFD')
    .replace(/[\u0300-\u036f]/g, '')
    .toUpperCase();

const ANYMARKET_STATUS_ALIASES: Record<string, string> = {
  PENDENTE: 'PENDING',
...
export const normalizeAnymarketStatusValue = (value: unknown) => {
