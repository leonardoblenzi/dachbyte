...
exports.sendSupportRequest = void 0;
...
const sendSupportRequest = async (req, res) => {
    ...
    const responsePreference = req.body?.responsePreference === 'phone' ? 'phone' : 'email';
    ...
    try {
        const result = await (0, supportRequestService_1.sendSupportRequestEmail)({
...
exports.sendSupportRequest = sendSupportRequest;
