...
exports.sendAccessEmail = void 0;
...
const escapeHtml = (value) => value
    ...
    .replace(/"/g, '&quot;')
    .replace(/'/g, '&#39;');
const getEmailCopy = (accessType) => {
    if (accessType === 'INVITE') {
        return {
            subject: 'Convite para acessar a plataforma Avantracking',
            title: 'Seu acesso esta pronto',
            intro: 'Voce foi convidado(a) para acessar a plataforma Avantracking. Clique no botao abaixo para cadastrar sua senha e liberar seu acesso.',
            buttonLabel: 'Cadastrar senha',
            footer: 'Se voce nao esperava este convite, apenas ignore esta mensagem.',
        };
    }
    return {
        subject: 'Redefinicao de senha - Avantracking',
        title: 'Redefina sua senha',
        intro: 'Recebemos uma solicitacao para redefinir a senha da sua conta na plataforma Avantracking. Clique no botao abaixo para continuar.',
        buttonLabel: 'Redefinir senha',
        footer: 'Se voce nao solicitou a redefinicao, ignore este e-mail. Sua senha atual continuara valida.',
    };
};
const buildAccessEmailHtml = ({ toName, accessType, actionUrl, expiresLabel, }) => {
...
const sendAccessEmail = async (input) => {
